...
**Ceiling Rule:** If A1 + A3 + A4 all score ≤ 2, cap ai_proof_score at **2.5** regardless of other scores. A job with no hard defenses is fundamentally exposed.

**Floor Rule:** If A9 or A10 scores **5**, minimum ai_proof_score is **3.0**. A role that actively expands due to AI's rise has meaningful resilience even with weak defenses.
